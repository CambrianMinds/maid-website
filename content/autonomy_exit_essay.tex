...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small \scshape Autonomy and the Right to Fuck Off Permanently}
\fancyhead[R]{\small \thepage}
\renewcommand{\headrulewidth}{0.5pt}
\renewcommand{\footrulewidth}{0pt}

% Metadata
\title{\textbf{\LARGE AUTONOMY AND THE RIGHT TO\\ FUCK OFF PERMANENTLY}\\[0.5em]
  ...
  \begin{@twocolumnfalse}
    ...
    \begin{center}
        ...
        \begin{minipage}{0.8\textwidth}
            ...
            I know how this looks. The genre conventions are all wrong. Personal essays written in this register belong in Substack, not journal formatting. The two-column layout is deliberate. Academic structure makes a claim about the seriousness of an argument---and this argument is serious, regardless of how it talks. If the formatting makes you uncomfortable, sit with that. The discomfort is the point.

            I am not in crisis. I am not a cautionary tale. I am a person who survived, spent nearly two decades turning the experience over in my hands like a broken watch, and arrived at a political position. That position deserves the same rigorous treatment as any other argument about bodily sovereignty. The profanity is not decoration. It is accurate.
        \end{minipage}
        \vspace{1em}
        \rule{0.6\textwidth}{0.5pt}
        \vspace{2em}
